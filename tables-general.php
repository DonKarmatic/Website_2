                ...
                <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <form class="row g-3 needs-validation" action="addstudent.php?msg1=<?=$theone?>" method="post" autocomplete="off">
                      <table class="table datatable">
                            ...
                            { $count = 1 + $count;
                              ...
                              ?>
                              <tr>
                                  <th scope="row"> <div class="col-12"><div class="form-check"> <input class="form-check-input" type="checkbox" name="sid" value="<?=$studentid1[$count]?>" id="sid">
                                    </div></th>
                                  <td><?=$username1[$count]?> </td>
                                  <td><?=$studentemail1[$count]?></td>
                                  <td><?=$studentid1[$count]?></td>
																	<!--<input type='hidden' name='namecourse' value=''/>
																	<input type='hidden' name='pleasework1' value='/>
																	<input type='hidden' name='pleasework2' value=''/>
																	<input type='hidden' name='pleasework3' value=''/>
                ...
                <div class="modal fade" id="exampleModalCenter1" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle1" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form class="row g-3 needs-validation" action="removestudent.php?msg1=<?=$theone?>" method="post" autocomplete="off">
                        <table class="table datatable">
                                <thead>
                                  <tr>
                              ...
                              { $count = 1 + $count;
                                ...
                                ?>
                                <tr>
                                    <th scope="row"> <div class="col-12"><div class="form-check"> <input class="form-check-input" type="checkbox" name="sid" value="<?=$studentid[$count]?>" id="sid">
                                      </div></th>
