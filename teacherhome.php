...
<div>
  ...
  <div class="modal fade" id="exampleModalCenter12" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle12" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Delete a Course</h5>
          <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <form class="row g-3 needs-validation" novalidate action="courseDeletion.php" method="post" autocomplete="off">
              <div class="col-12">
                <label for="teacherid" class="form-label">Your ID is: <?=$_SESSION['id']?></label>
              </div>  
              <div class="col-12">
            ...
            <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit">Delete Course</button>
            </div>
          </form>
        </div>
      </div>
