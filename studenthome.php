...
<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="student-general.php">
        <i class="bi bi-grid"></i>
        <span>Courses</span>
      </a>
    </li><!-- End Courses Nav -->
...
<section>
            ...
            <?php   // LOOP TILL END OF DATA
              ...
              {$count = 1 + $count;
							 $courses = $rows['Coursename'];  //taking course name
							 $sql1 = "SELECT studentid FROM $courses "; //getting list of students in course
               $mysqli1 = mysqli_connect($DATABASE_HOST, $DATABASE_USER, $DATABASE_PASS, $DATABASE_NAME);
							 $result1 = $mysqli1->query($sql1);
							 while($srow=$result1->fetch_assoc()){
                if($idpart == $srow['studentid']){
             ?>
            <tr>
  ...
  <div class="row">
    ...
    <div class="col-lg-6  ">
      ...
      <div class="row mr-auto p-2 ">
        ...
        <div class="card">
          <div class="card-body ">
            <a class="card-title" href="student-general.php?msg=<?=$coursename[$count]?>"><?=$coursename[$count]?></a>
            <!-- Default Table -->
            <table class="table">
              <thead>
                <tr>
